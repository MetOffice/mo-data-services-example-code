...
5. ### Start polling the SQS queue.
   ...
   * The -k flag set keeps messages until deleted by the user.
   ...
   Checking queue for messages...
   {'metadata': {'forecast_reference_time': '2017-10-24T06:00:00Z', 'forecast_period': '0', 'name': 'dew_point_temperature', 'forecast_period_units': 'seconds'}, 'url':  'https://<service-url-supplied-by-Met-Office/id-of-item-requested>'}
   Checking queue for messages...
   ...
   ```
